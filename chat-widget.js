...
(function () {
  ...
  #tchat-btn {
    ...
    background: #ffffff;
    border: 1.5px solid rgba(47,149,214,0.5);
    box-shadow: 0 8px 24px rgba(47,149,214,0.3), 0 2px 8px rgba(13,43,69,0.12);
    display: flex; align-items: center; justify-content: center;
    cursor: pointer; transition: box-shadow 0.35s, transform 0.25s;
  }
  #tchat-btn:hover {
    box-shadow: 0 12px 32px rgba(47,149,214,0.42), 0 4px 12px rgba(13,43,69,0.16);
  ...
  #tchat-btn .tchat-notif {
    ...
    background: #2f95d6; border: 2px solid #ffffff;
    animation: tchat-pulse 2s infinite;
    display: none;
  }
  @keyframes tchat-pulse {
    0%, 100% { box-shadow: 0 0 0 0 rgba(47,149,214,0.6); }
    50%       { box-shadow: 0 0 0 6px rgba(47,149,214,0); }
  }
  ...
  #tchat-panel {
    ...
    background: #ffffff;
    border: 1px solid rgba(47,149,214,0.3);
    border-radius: 18px;
    box-shadow: 0 24px 70px rgba(13,43,69,0.20), 0 2px 8px rgba(13,43,69,0.08);
  ...
  .tchat-header {
    ...
    border-bottom: 1px solid rgba(53,89,122,0.14);
    display: flex; align-items: center; gap: 12px;
    background: #f5fafe;
  }
  .tchat-avatar {
    width: 36px; height: 36px; border-radius: 50%;
    background: linear-gradient(135deg, #0f5b8f, #2f95d6);
    display: flex; align-items: center; justify-content: center;
    font-size: 15px; flex-shrink: 0;
    box-shadow: 0 4px 12px rgba(47,149,214,0.35);
  }
  .tchat-header-info { flex: 1; }
  .tchat-header-name {
    font-family: 'Anton', 'Arial Narrow', sans-serif;
    text-transform: uppercase; letter-spacing: 0.1em;
    font-size: 15px; color: #0d2b45; line-height: 1;
  }
  .tchat-header-sub {
    font-size: 11px; color: rgba(53,89,122,0.8);
    letter-spacing: 0.04em; margin-top: 3px; display: flex; align-items: center; gap: 5px;
  }
  .tchat-status-dot {
    width: 6px; height: 6px; border-radius: 50%;
    background: #1a7f37; box-shadow: 0 0 8px #1a7f37;
    display: inline-block; flex-shrink: 0;
  }
  .tchat-close {
    background: none; border: none; color: rgba(53,89,122,0.7);
    cursor: pointer; padding: 4px; border-radius: 6px;
    line-height: 0; transition: color 0.2s;
  }
  .tchat-close:hover { color: #0d2b45; }
  ...
  .tchat-tab {
    ...
    color: rgba(53,89,122,0.7);
    border-bottom: 2px solid transparent;
    margin-bottom: -1px;
    transition: color 0.25s, border-color 0.25s;
    font-family: inherit;
  }
  .tchat-tab.active { color: #1273b5; border-bottom-color: #2f95d6; }
  ...
  .tchat-messages::-webkit-scrollbar-thumb { background: rgba(47,149,214,0.3); border-radius: 2px; }
  ...
  .tchat-msg.user .tchat-bubble {
    background: rgba(47,149,214,0.14); color: #0d2b45;
    border: 1px solid rgba(47,149,214,0.32);
    border-bottom-right-radius: 4px;
  }
  .tchat-msg.ai .tchat-bubble {
    background: #f0f7fd; color: #0d2b45;
    border: 1px solid rgba(53,89,122,0.12);
    border-bottom-left-radius: 4px;
  }
  .tchat-time {
    font-size: 10px; color: rgba(53,89,122,0.6);
  ...
  .tchat-typing .dot {
    width: 6px; height: 6px; border-radius: 50%;
    background: rgba(47,149,214,0.6);
  ...
  .tchat-input-row {
    padding: 12px 14px;
    border-top: 1px solid rgba(53,89,122,0.14);
    display: flex; gap: 8px; align-items: flex-end;
    background: #f5fafe;
  }
  .tchat-input {
    flex: 1; background: #f5fafe;
    border: 1px solid rgba(53,89,122,0.15); border-radius: 10px;
    color: #0d2b45; font-family: inherit; font-size: 13.5px;
    padding: 9px 12px; resize: none; min-height: 38px; max-height: 100px;
    line-height: 1.45; outline: none;
    transition: border-color 0.25s;
  }
  .tchat-input::placeholder { color: rgba(53,89,122,0.6); }
  .tchat-input:focus { border-color: rgba(47,149,214,0.5); }
  .tchat-send {
    width: 36px; height: 36px; border-radius: 10px; flex-shrink: 0;
    background: rgba(47,149,214,0.2); border: 1px solid rgba(47,149,214,0.4);
    color: #1273b5; cursor: pointer; display: flex; align-items: center; justify-content: center;
    transition: background 0.25s, box-shadow 0.25s; line-height: 0;
  }
  .tchat-send:hover { background: rgba(47,149,214,0.3); box-shadow: 0 4px 12px rgba(47,149,214,0.28); }
  ...
  .tchat-field label { font-size: 11px; letter-spacing: 0.16em; text-transform: uppercase; color: rgba(53,89,122,0.85); }
  .tchat-field input, .tchat-field textarea, .tchat-field select {
    background: #f5fafe; border: 1px solid #bcdcf0;
    border-radius: 8px; color: #0d2b45; font-family: inherit;
    font-size: 13px; padding: 9px 11px; outline: none;
    transition: border-color 0.25s;
  }
  .tchat-field input:focus, .tchat-field textarea:focus { border-color: rgba(47,149,214,0.5); }
  .tchat-field textarea { resize: vertical; min-height: 80px; }
  .tchat-field input::placeholder, .tchat-field textarea::placeholder { color: rgba(53,89,122,0.55); }
  .tchat-submit {
    padding: 11px; border-radius: 10px;
    background: rgba(47,149,214,0.18); border: 1px solid rgba(47,149,214,0.4);
    color: #1273b5; font-family: inherit; font-size: 12px;
    font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase;
    cursor: pointer; transition: background 0.3s, box-shadow 0.3s;
    margin-top: 4px;
  }
  .tchat-submit:hover { background: rgba(47,149,214,0.26); box-shadow: 0 4px 14px rgba(47,149,214,0.26); }
  ...
  <button id="tchat-btn" aria-label="Open chat">
    ...
    <svg id="tchat-icon-open" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1273b5" stroke-width="1.8">
      <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
    </svg>
    <svg id="tchat-icon-close" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1273b5" stroke-width="2" style="display:none;">
  ...
  <div id="tchat-panel" role="dialog" aria-label="CGW Chat">
    ...
    <div class="tchat-header">
      <div class="tchat-avatar"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3v18M3 12h18M6 6l12 12M18 6L6 18"/></svg></div>
    ...
    <div id="tchat-tab-email" style="display:none;flex-direction:column;flex:1;overflow:hidden;">
      <div class="tchat-email-form">
        <p style="font-size:13px;color:rgba(53,89,122,0.85);line-height:1.6;margin:0 0 4px;">
        ...
        <div class="tchat-field">
          <label>Subject</label>
          <select id="em-subject" style="background:#f5fafe;border:1px solid #bcdcf0;border-radius:8px;color:#0d2b45;font-family:inherit;font-size:13px;padding:9px 11px;outline:none;cursor:pointer;">
            <option value="General Enquiry" style="background:#ffffff;color:#0d2b45;">General Enquiry</option>
            <option value="Project Proposal" style="background:#ffffff;color:#0d2b45;">Project Proposal</option>
            <option value="Careers / Jobs" style="background:#ffffff;color:#0d2b45;">Careers / Jobs</option>
            <option value="Support" style="background:#ffffff;color:#0d2b45;">Support</option>
            <option value="Pricing" style="background:#ffffff;color:#0d2b45;">Pricing</option>
          </select>
        </div>
        <div class="tchat-field">
          <label>Message</label>
  ...
  document.getElementById('em-submit').addEventListener('click', async function() {
    ...
    if (!name || !email || !message) {
      msgEl.style.color = '#c02626';
      msgEl.textContent = 'Please fill in name, email and message.';
      return;
    }

    this.disabled = true;
    msgEl.style.color = 'rgba(53,89,122,0.85)';
